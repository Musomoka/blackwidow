...
class MentorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post mentors_url, params: { mentor: { descritpion: @mentor.descritpion, user_id: @mentor.user_id } }
    end
  ...
  test "should update mentor" do
    patch mentor_url(@mentor), params: { mentor: { descritpion: @mentor.descritpion, user_id: @mentor.user_id } }
